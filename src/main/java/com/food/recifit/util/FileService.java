...
public class FileService {
	...
	//문법 외우기. static이 있어서 밖에서 FileService.saveFile  이렇게 해서 부를수 있다. 
	public static String saveFile(MultipartFile mfile, String uploadPath) {
		...
		//lastIndexOf부터 .을 찾아라
		//만약 찾지 못한다면 -1반환
		//찾으면 lastIndex(.있는데)에서 뒷부분 짤라서 확장자
		...
		//파일 저장
		//이부분 다시 보기 
		//mfile.transferTo(serverFile);실제로 저장되는데
		try {
