...
public class ZzimRestController {
		...
		public String insertzzim(Zzim zzim, MultipartFile upload) {
		...
		//찜 파일 다운로드
		@GetMapping("/zzimdownload")
		public String zzimdownload(
				@RequestParam(name = "num", defaultValue="0") int num
		...
		public String updatezzim(int zzim_num, Model model, @AuthenticationPrincipal UserDetails user) {
			...
			model.addAttribute("Zzim", zzim);
			//수정폼 html로 포워딩	
			return "recipeView/updatezzim.html";
		}
